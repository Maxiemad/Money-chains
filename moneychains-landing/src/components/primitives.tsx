...
/** Inline Apple mark — used as decorative macOS chrome in the menu bar. */
...
/** MoneyChains abstract 4-quadrant curve mark. */
...
/**
 * Primary pill CTA. Keeps the exact white-pill treatment from the design;
 * content aligned to MoneyChains (web app → "Start free", brand mark instead
 * of the Apple/download framing).
 */
...
/** Root-level subtle grain filter (multiply) referenced by the headline. */
